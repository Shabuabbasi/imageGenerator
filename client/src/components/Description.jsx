...
const Description = () => {
  return (
    <motion.div
      className="flex flex-col items-center justify-center my-24 p-6 md:px-26"
    ...
    >
      ...
      <p className="text-gray-600 mb-8">Bring Creative Vision to Life</p>
      <div className="flex flex-col gap-5 md:gap-14 md:flex-row items-center">
        ...
        />
        <div>
          <h2 className="text-3xl font-medium max-w-lg mb-8">
